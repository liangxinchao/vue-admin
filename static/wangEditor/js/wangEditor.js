    ...
    E.fn.command = function (e, commandName, commandValue, callback) {
        ...
        function commandFn() {
            ...
            if (editor.queryCommandSupported(commandName)) {
                ...
                //add by queena at 2017/05/08，解决document.execCommand()处理字体大小时只有1-7的bug
                if(commandName == 'fontSize'){
                   $("font[size]").removeAttr("size").css("font-size", commandValue); 
                }
                // if(commandName == 'formatBlock'){
                //     $('h6').prepend('<span style="display:block; float:left; width:4px; height:16px; background:#444c56; border-radius:4px; margin-right:7px;"></span>').css({ "color": "#464c56", "font-size": '16px', "line-height": '16px'});
                // }
...
_e(function (E, $) {
    ...
    //modify by queena at 2017/05/05
    // 菜单配置
    // E.config.menus = [
    //     'source',
    //     '|',
    ...
    E.config.menus = ['source', '|', 'bold', 'underline', 'italic', 'strikethrough', 'eraser', 'forecolor', 'bgcolor', '|', 'quote', 'fontfamily', 'fontsize', 'lineheight','indent', 'head', 'unorderlist', 'orderlist', 'alignleft', 'aligncenter', 'alignright', '|', 'link', 'unlink', 'table', 'emotion', '|', 'img', '|', 'undo', 'redo', 'fullscreen'];
    ...
    E.config.emotions = {
        ...
        'weibo': {
            ...
            data: [
                ...
                {
                    icon: 'https://img.alicdn.com/imgextra/i1/1760739528/TB2e6_SoHtlpuFjSspfXXXLUpXa_!!1760739528.jpg',
                    value: '标题前'
                }
            ]
        }
...
_e(function (E, $) {
    E.createMenu(function (check) {
        ...
        */
        ...
        // 创建droplist
        var tpl = '<span class="myFontSize" commandValue="{#commandValue}" style="font-size:{#commandValue};">{#title}</span>';
        menu.dropList = new E.DropList(editor, menu, {
            data: data,
            tpl: tpl,
...
_e(function (E, $) {
    E.createMenu(function (check) {
        ...
        */
        ...
        menu.updateSelectedEvent = function () {
            var rangeElem = editor.getRangeElem();
            rangeElem = editor.getSelfOrParentByName(rangeElem, 'h1,h2,h3,h4,h5,title');
            if (rangeElem) {
                return true;
            }
            return false;
