<template>
  <el-form :model="form" ref="form" label-width="120px" label="right" class="manageForm">
    ...
    <el-form-item label="入驻企业：" required>
      <el-input v-model="form.company" :disabled="true"></el-input>
    </el-form-item>
    <el-form-item label="入驻园区:" required>{{form.park}}</el-form-item>
    ...
    <el-form-item label="户籍地址:" class="small-ipt" required>
      <el-input v-model="form.address" placeholder="请填写您的户籍地址" :disabled="true"></el-input>
    </el-form-item>
