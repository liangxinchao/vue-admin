<template>
  <el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="100px" label="right" class="manageForm">
    ...
    <p class="info">
      <label>创 建 人：</label><span>张三三</span>
    </p>
    <p class="info">
      <label>创建时间：</label><span>2016-10-10 08:00</span>
    </p>
    ...
    <el-form-item label="话题详情:" style="width:980px;" prop='content' required>
      <div id="activityContent" style="height:260px;"></div>
    </el-form-item>
    <p class="model">宣传设置</p>
    <p class="info">
      <label>参 与 数：</label><span>12</span>
    </p>
    <p class="info">
      <label>点 击 数：</label><span>50</span>
    </p>
