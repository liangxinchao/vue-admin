<template>
  <div>
    ...
    <el-table :data='tableData' highlight-current-row @selection-change="selsChange">
      ...
      <el-table-column prop="updated" label="取消时间" width="115" sortable></el-table-column>
